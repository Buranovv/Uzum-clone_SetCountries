      ...
      >
        ...
        ></path>
          ...
          <div class="card-body">
            ...
            <button data-id="${
              array[i].id
            }" class="btn btn-danger w-100" id="delete-btn">Delete</button>
            <button data-id="${
              array[i].id
            }" class="btn btn-primary w-100" data-bs-toggle="modal" data-bs-target="#exampleModal" id="edit-btn">Edit</button>
            </div>
            </div>
          </div>
          `;
